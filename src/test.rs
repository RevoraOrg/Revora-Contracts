...
fn calculate_distribution_zero_revenue() {
    ...
    let payout = client.calculate_distribution(&issuer, &issuer, &token, &0, &1_000, &100, &holder);
...
fn calculate_distribution_zero_balance() {
    ...
    let payout =
        client.calculate_distribution(&issuer, &issuer, &token, &1_000_000, &1_000, &0, &holder);
...
fn calculate_distribution_zero_supply_panics() {
    ...
    client.calculate_distribution(&issuer, &issuer, &token, &1_000_000, &0, &100, &holder);
}
...
fn calculate_distribution_without_offering_panics() {
    ...
    client.calculate_distribution(&issuer, &issuer, &token, &1_000_000, &1_000, &100, &holder);
}
...
fn calculate_total_distributable_basic() {
    ...
    let distributable = client.calculate_total_distributable(&issuer, &token, &1_000_000);
...
fn calculate_total_distributable_zero_revenue() {
    ...
    let distributable = client.calculate_total_distributable(&issuer, &token, &0);
...
fn calculate_total_distributable_without_offering_panics() {
    ...
    client.calculate_total_distributable(&issuer, &token, &1_000_000);
}
