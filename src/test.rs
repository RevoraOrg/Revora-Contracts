...
fn get_revenue_range_sums_periods() {
    ...
    let token = Address::generate(&env);
    let payout_asset = Address::generate(&env);
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &1000, &payout_asset, &0);
...
fn gas_characterization_report_revenue_with_large_blacklist() {
    ...
    let token = Address::generate(&env);
    let payout_asset = Address::generate(&env);
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &500, &payout_asset, &0);
...
fn large_period_range_sums_correctly() {
    ...
    let issuer = Address::generate(&env);
    let token = Address::generate(&env);
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &1_000, &token, &0);
...
fn audit_summary_per_offering_isolation() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token_a, &1_000, &payout_asset_a, &0);
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token_b, &1_000, &payout_asset_b, &0);
    client.report_revenue(
        &issuer,
        &symbol_short!("def"),
        &token_a,
...
fn claim_setup() -> (Env, RevoraRevenueShareClient<'static>, Address, Address, Address, Address) {
    ...
    // Register offering
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &5_000, &payment_token, &0); // 50% revenue share
...
fn deposit_revenue_rejects_mismatched_token_after_lock() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &5_000, &locked_token, &0);
...
fn payment_token_lock_is_per_offering() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token_a, &5_000, &asset_a, &0);
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token_b, &5_000, &asset_b, &0);
...
fn payment_token_none_before_first_deposit() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &5_000, &payout, &0);
...
fn payment_token_mismatch_returns_correct_error_code() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &5_000, &payout_a, &0);
...
fn multi_offering_different_payment_tokens_independent() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("multi"), &token_a, &5_000, &payment_token_x, &0);
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("multi"), &token_b, &5_000, &payment_token_y, &0);
...
fn multi_offering_cross_deposit_fails_with_payment_token_mismatch() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("multi"), &token_a, &5_000, &token_x, &0);
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("multi"), &token_b, &5_000, &token_y, &0);
...
fn multi_offering_same_payment_token_both_offerings() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("multi"), &token_a, &5_000, &payment_token, &0);
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("multi"), &token_b, &5_000, &payment_token, &0);
...
fn multi_offering_three_offerings_full_isolation() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("multi"), &token_a, &5_000, &token_x, &0);
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("multi"), &token_b, &5_000, &token_y, &0);
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("multi"), &token_c, &5_000, &token_z, &0);
...
fn claim_normalizes_6_decimal_token_revenue() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &5_000, &payment_token, &0);
...
fn deposit_revenue_exactly_at_supply_cap_succeeds() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &5_000, &payment_token, &100_000);
    mint_tokens(&env, &payment_token, &pt_admin, &issuer, &10_000_000);
...
fn register_capped_offering(
    ...
    client.register_offering(issuer, &Vec::new(&env), &1u32, &symbol_short!("cap"), token, &5_000, payment_token, &cap);
}
...
fn get_deposited_revenue_returns_zero_before_any_deposit() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("cap"), &token, &5_000, &payment_token, &100_000);
...
fn deposit_revenue_no_cap_is_unlimited() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("cap"), &token, &5_000, &payment_token, &0);
...
fn offering_isolation_claims_independent() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token_b, &3_000, &pt_b, &0);
...
fn freeze_offering_blocks_only_target_offering() {
    ...
    let token_b = Address::generate(&env);
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token_b, &5_000, &payment_token, &0);
...
fn testnet_mode_toggle_after_offerings_exist() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token1, &5_000, &payout_asset1, &0);
...
fn testnet_mode_affects_only_validation_not_storage() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &25_000, &payout_asset, &0);
...
fn testnet_mode_multiple_offerings_with_varied_bps() {
    ...
    for i in 1..=5 {
        ...
        let payout_asset = Address::generate(&env);
        client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &bps, &payout_asset, &0);
    }
...
fn issuer_transfer_multiple_offerings_isolation() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token_b, &3_000, &token_b, &0);
...
fn issuer_transfer_wrong_address_cannot_accept() {
    ...
    client2.register_offering(&issuer2, &Vec::new(&env), &1u32, &symbol_short!("def"), &token2, &1_000, &payout2, &0);
...
fn testnet_mode_normal_operations_unaffected() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &5_000, &payout_asset, &0);
    client.report_revenue(
        &issuer,
        &symbol_short!("def"),
        &token,
...
fn register_blocked_while_paused() {
    ...
    client.pause_admin(&admin);
    assert!(client
        .try_register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &1_000, &payout_asset, &0)
        .is_err());
}
    ...
    for issuer in issuers.iter() {
        ...
        for i in 0..offerings_page.0.len() {
            ...
            if client.is_paused() {
                ...
                let result = client.try_register_offering(&issuer, &Vec::new(&env), &1u32, &ns, &dummy_token, &1000, &dummy_token, &0);
        ...
        for op in seq {
            match op {
                TestOperation::RegisterOffering((i, ns, t, bps, pa)) => {
                    client.register_offering(&i, &Vec::new(&env), &1u32, &ns, &t, &bps, &pa, &0);
                }
...
proptest! {
    ...
    fn prop_concentration_limits(
        ...
        client.register_offering(&issuer, &Vec::new(&env), &1u32, &ns, &token, &1000, &token.clone(), &0);
...
proptest! {
    ...
    fn prop_pause_safety(env in Env::default()) {
        ...
        let result = std::panic::catch_unwind(|| {
            client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &1000, &token.clone(), &0);
        });
...
proptest! {
    ...
    fn prop_blacklist_enforcement(
        ...
        let (i, ns, t) = offering;
        let client = make_client(&env);
        client.register_offering(&i, &Vec::new(&env), &1u32, &ns, &t, &1000, &t.clone(), &0);
...
proptest! {
    ...
    fn prop_pagination_stability(
        ...
        for _ in 0..n {
            let token = Address::generate(&env);
            client.register_offering(&issuer, &Vec::new(&env), &1u32, &ns, &token, &1000, &token, &0);
        }
...
fn calculate_distribution_bps_100_percent() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &10_000, &token, &0);
...
fn calculate_distribution_bps_25_percent() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &2_500, &token, &0);
...
fn calculate_distribution_rounds_down() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &3_333, &token, &0);
...
fn calculate_distribution_multiple_holders_sum() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &5_000, &token, &0);
...
fn calculate_distribution_offering_isolation() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token_b, &8_000, &token_b, &0);
...
fn test_set_offering_metadata_success() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &1000, &token, &0);
...
fn test_metadata_scoped_per_offering() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token_a, &1000, &token_a, &0);
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token_b, &2000, &token_b, &0);
...
fn test_metadata_multiple_offerings_same_issuer() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token1, &1000, &token1, &0);
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token2, &2000, &token2, &0);
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token3, &3000, &token3, &0);
...
fn test_metadata_after_issuer_transfer() {
    ...
    client.register_offering(&old_issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &1000, &token, &0);
...
mod regression {
    ...
    fn get_offerings_page_order_is_by_registration_index() {
        ...
        client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &t0, &100, &p0, &0);
        client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &t1, &200, &p1, &0);
        client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &t2, &300, &p2, &0);
        client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &t3, &400, &p3, &0);
    ...
    fn regression_issue_360_get_offering_direct_lookup() {
        ...
        client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &token, &500, &payout, &0);
    ...
    fn regression_issue_360_get_offering_many_offerings_still_finds_correct() {
        ...
        for i in 0..10u32 {
            ...
            client.register_offering(&issuer, &Vec::new(&env), &1u32, &symbol_short!("def"), &t, &(i * 100), &payout, &0);
            if i == 9 {
                target_token = t;
            }
        }
...
fn test_offerings_page_pagination_25_offerings() {
    ...
    for i in 0..25 {
        ...
        client.register_offering(&issuer1, &Vec::new(&env), &1u32, &ns, &token, &(1000 + i * 100), &token, &0);
    }
...
fn test_offerings_page_ordering_deterministic() {
    ...
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &ns, &t0, &100, &t0, &0);
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &ns, &t1, &200, &t1, &0);
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &ns, &t2, &300, &t2, &0);
    client.register_offering(&issuer, &Vec::new(&env), &1u32, &ns, &t3, &400, &t3, &0);
...
fn test_offerings_page_after_issuer_transfer() {
    ...
    client.register_offering(&issuer1, &Vec::new(&env), &1u32, &ns, &t1, &100, &t1, &0);
    client.register_offering(&issuer1, &Vec::new(&env), &1u32, &ns, &t2, &200, &t2, &0);
    client.register_offering(&issuer1, &Vec::new(&env), &1u32, &ns, &t3, &300, &t3, &0);
...
fn test_issuer_transfer_migrates_all_configs() {
    ...
    client.register_offering(&old_issuer, &Vec::new(&env), &1u32, &ns, &token, &1000, &payout_asset, &0);
