...
const CORE_LAYOUT: &[StorageLayoutEntry] = storage_layout_entries!("revora_revenue_share", [
    ...
    ("DataKey2::OfferingPlatformFee(OfferingId)", "OfferingPlatformFee", "offering"),
    ...
    ("DataKey2::EmergencyFreeze(OfferingId, Address)", "FreezeReason", "offering+holder"),
    ("DataKey2::TotalSharesIssued(OfferingId)", "i128", "offering"),
    ("DataKey2::MaxTotalSupplyShares(OfferingId)", "i128", "offering"),
    ("DataKey2::FaucetSeedEntry(OfferingId, u32)", "BytesN<32>", "offering+index"),
    ("DataKey2::FaucetMetricsWindow", "u64", "contract"),
    ("DataKey2::FaucetMetricsTotalDispensed", "u32", "contract"),
    ("DataKey2::FaucetMetricsUniqueAddrs", "u32", "contract"),
    ("DataKey2::FaucetMetricsCooldownRejects", "u32", "contract"),
    ("DataKey2::FaucetMetricsAddrSeen(u64, Address)", "bool", "window+address"),
