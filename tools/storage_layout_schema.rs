...
const CORE_LAYOUT: &[StorageLayoutEntry] = storage_layout_entries!("revora_revenue_share", [
    ...
    ("DataKey2::AccrualIndex(OfferingId)", "i128", "offering"),
    ...
    ("DataKey2::GovProposal(OfferingId, u32)", "GovProposalEntry", "offering+proposal"),
    ...
    ("DataKey2::OfferingPlatformFee(OfferingId)", "u32", "offering"),
