...
const CORE_LAYOUT: &[StorageLayoutEntry] = storage_layout_entries!("revora_revenue_share", [
    ...
    ("DataKey2::GlobalFreezeReason", "Symbol", "contract"),
    ...
    ("DataKey2::ClassConversionRatio(OfferingId, ShareClass, ShareClass)", "u32", "offering+classes"),
    ...
    ("DataKey2::FiscalYearStartMonth(OfferingId)", "u32", "offering"),
    ("DataKey2::TaxYearEntry(OfferingId, Address, u64)", "TaxYearSummary", "offering+holder+year"),
